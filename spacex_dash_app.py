...
def get_pie_chart(selected_site):
    if selected_site == 'ALL':
        ...
        fig = px.pie(success_counts, values=success_counts.values, names=success_counts.index, title='Success Launches by Launch Site')
        return fig
    else:
        ...
        total_count = filtered_df['class'].count()
        success_rate = success_count / total_count

        fig = go.Figure(data=[go.Pie(labels=['Success', 'Failure'], values=[success_count, total_count - success_count])])
...
def update_scatter_chart(selected_site, payload_range):
    if selected_site == 'ALL':
        ...
        title = "Payload Scatter Chart for All Sites"
        ...
        title = f"Payload Scatter Chart for {selected_site}"
        color_column = 'Booster Version Category'
